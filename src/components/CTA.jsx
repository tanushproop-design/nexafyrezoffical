  ...
  return (
    <section className="cta-section" style={{ paddingBottom: '6rem' }}>
      <div className="section-container" style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
        ...
        <ScrollReveal>
          <div className="cta-box" style={{ background: 'rgba(124, 58, 237, 0.05)', borderColor: 'rgba(124, 58, 237, 0.2)' }}>
            <div className="cta-glow" style={{ background: 'radial-gradient(circle, rgba(124, 58, 237, 0.15) 0%, rgba(0,0,0,0) 70%)' }}></div>
            <h2 className="cta-title">Want Your <span className="gradient-text" style={{ background: 'linear-gradient(135deg, #7c3aed 0%, #00d4ff 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Own Bot</span>?</h2>
            ...
            <Link to="/bots" className="btn btn-primary btn-large" style={{ background: 'linear-gradient(135deg, #7c3aed 0%, #00d4ff 100%)', border: 'none', color: '#fff' }}>
