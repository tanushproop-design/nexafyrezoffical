...
const botsData = [
  ...
  },
  {
    ...
    name: 'HeliXx Music',
    icon: 'fas fa-music',
    desc: 'Premium music bot with high-fidelity playback, filters, and queue management.',
    fullDesc: 'HeliXx Music delivers immersive audio playback supporting YouTube, Spotify, SoundCloud, and more. Equipped with bass boost, nightcore, vaporwave, and other audio filters for a premium listening experience.',
    inviteUrl: '#',
    tags: ['Music', 'Audio Filters', 'Queue', 'Playlists', 'Spotify', 'YouTube'],
    commands: [
      ...
      { name: 'nowplaying', desc: 'Show currently playing track', category: 'Music' },
      { name: 'shuffle', desc: 'Shuffle the queue', category: 'Music' },
      { name: 'seek', desc: 'Seek to a position in the track', category: 'Music' },
      { name: 'lyrics', desc: 'Get lyrics for current song', category: 'Music' },
      { name: 'filter', desc: 'Apply audio filters (bass, nightcore)', category: 'Filters' },
      { name: 'bassboost', desc: 'Toggle bass boost', category: 'Filters' },
      { name: 'nightcore', desc: 'Toggle nightcore effect', category: 'Filters' },
      { name: 'support', desc: 'Get support server link', category: 'Utility' },
  ...
  },
  {
    ...
    name: 'HeliXx !!',
    icon: 'fas fa-bolt',
    desc: 'Core utility and moderation bot for the Helix community.',
    fullDesc: 'HeliXx !! is the core community bot handling moderation, utility commands, and server management. Always online and ready to assist.',
    inviteUrl: '#',
    tags: ['Moderation', 'Utility', 'Management', 'Community'],
    commands: [
      { name: 'ban', desc: 'Ban a member', category: 'Moderation' },
      ...
      { name: 'userinfo', desc: 'View user info', category: 'Utility' },
      { name: 'serverinfo', desc: 'View server info', category: 'Utility' },
      { name: 'avatar', desc: "View user's avatar", category: 'Utility' },
      { name: 'help', desc: 'View all commands', category: 'Utility' },
    ]
  },
  {
  ...
  },
  {
    ...
    name: 'Top Dawg !!',
    icon: 'fas fa-trophy',
    desc: 'Leveling, rankings, and competitive features for the community.',
    fullDesc: 'Top Dawg !! powers the competitive side of Helix with leveling systems, XP tracking, role rewards, and leaderboards to keep the community engaged and active.',
    inviteUrl: '#',
    tags: ['Leveling', 'XP', 'Rankings', 'Rewards', 'Leaderboard'],
    commands: [
      { name: 'rank', desc: 'View your rank and XP', category: 'Leveling' },
      { name: 'leaderboard', desc: 'View the XP leaderboard', category: 'Leveling' },
      { name: 'top', desc: 'View top ranked members', category: 'Leveling' },
      { name: 'setlevel', desc: "Set a member's level", category: 'Admin' },
      { name: 'addxp', desc: 'Add XP to a member', category: 'Admin' },
      { name: 'removexp', desc: 'Remove XP from a member', category: 'Admin' },
      { name: 'levelrole', desc: 'Set role reward for a level', category: 'Admin' },
      { name: 'xpreset', desc: 'Reset all XP data', category: 'Admin' },
    ]
  },
  {
    id: 'helix-auth',
